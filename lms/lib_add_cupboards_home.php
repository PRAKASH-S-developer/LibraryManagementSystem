    ...
    <div class="container my-4">
        ...
        <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">View All Cupboard</h5>
                        <p class="card-text">View All Cupboard details.</p>
                        <a href="lib_view_all_cupboards.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">Add New Cupboard</h5>
                        <p class="card-text">Adding new Cupboard details to the system.</p>
                        <a href="lib_add_new_cupboard.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">Delete or Update Cupboard</h5>
                        <p class="card-text">Delete Or Update Cupboard.</p>
                        <a href="lib_delete_update_cupboard.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>

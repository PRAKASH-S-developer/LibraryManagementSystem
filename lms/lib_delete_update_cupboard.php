        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="lib_add_cupboards_home.php">Back</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container my-4">
        ...
        <?php if (!empty($feedback_message)): ?>
            ...
            <?php if ($redirect): ?>
                <script>
                    setTimeout(function() {
                        window.location.href = 'lib_add_cupboards_home.php';
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="lib_delete_update_cupboard.php?delete=<?php echo $row['cupboard_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this cupboard?');">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>

    ...
    if (!empty($username) && !empty($selectyourdegree) && !empty($selectyourcourse) && !empty($rollno) && !empty($email) && !empty($number) && !empty($address) && !empty($password) && !empty($batch_starting_year) && !empty($batch_ending_year) && !empty($college_join_date)) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            if ($result) {
                ...
                echo '<meta http-equiv="refresh" content="1; url=lib_add_students_home.php"/>';
            } else {
...
<head>
    ...
    <style>
        body {
            background-image: url('streg_ORG2.jpg');
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="lib_add_students_home.php">Back</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="form-container">
                    <h2 class="form-title">Students Account Create</h2>

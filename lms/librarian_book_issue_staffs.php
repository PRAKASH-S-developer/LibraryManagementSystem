...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $delete_query = "DELETE FROM temp_staffs_borrow_book_request WHERE bid='$id'";
    mysqli_query($conn, $delete_query);
    header("Location: librarian_book_issue.php");
    exit();
}

// Fetch all books
$query = "SELECT * FROM temp_staffs_borrow_book_request";
...
<head>
    ...
    <title>Staffs Borrow Book Request</title>
...
<div class="container mt-5">
    <h2 class="text-center mb-4 text-warning">📚 Staffs Borrow Book Request</h2>
    ...
    <a href="librarian_renew_staffs_books.php" class="btn btn-primary">Renew</a>
        ...
        <tbody id="bookTable">
            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                    ...
                    <td>
                        <a href="issue_books_to_staffs.php?bid=<?php echo $row['bid']; ?>&staff_id=<?php echo $row['staff_id']; ?>" class="btn btn-sm btn-primary">Issue</a><br><br>
                        <a href="?delete=<?php echo $row['bid']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this book?');">Reject</a>
                    </td>

...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $delete_query = "DELETE FROM temp_borrow_book_request WHERE bid='$id' AND stu_id='$stu_id'";
...
// Fetch all books
$query = "SELECT * FROM temp_borrow_book_request";
        ...
        <tbody id="bookTable">
            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                    ...
                    <td>
                        <a href="issue_books_to_students.php?bid=<?php echo $row['bid']; ?>&stu_id=<?php echo $row['stu_id']; ?>" class="btn btn-sm btn-primary">Issue</a><br><br>
                        <a href="?delete=<?php echo $row['bid']; echo $row['stu_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this book?');">Reject</a>
                    </td>

        ...
        <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        ...
                        <a href="view_all_students.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        ...
                        <a href="lib_student_acc_create.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        ...
                        <a href="lib_delete_update_students.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>

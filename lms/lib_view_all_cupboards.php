...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <form method="POST" action="">
                            <button  class="btn btn-danger btn-sm"><a href="lib_add_cupboards_home.php">Back</a></button>
                        </form>
                    </li> &nbsp;&nbsp;&nbsp;&nbsp;
                    <li class="nav-item">
                        <form method="POST" action="">
    ...
    <div class="container my-4">
        <h1 class="text-center mb-4">Available Cupboard</h1>

        <table class="table table-bordered table-hover">
            <thead class="table-dark">
                <tr>
                    <th scope="col">Cupboard ID</th>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<td>" . $row['cupboard_id'] . "</td>";
                        echo "<td>" . $row['cupboard_name'] . "</td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='2' class='text-center'>No cupboard available</td></tr>";
                }
                ?>
            </tbody>
        </table>

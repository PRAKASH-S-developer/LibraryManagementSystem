...
if (isset($_POST["login"])) {
    ...
    if (!empty($username) && !empty($rollno) && !empty($email) && !empty($password)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                $alertType = "success";
                echo '<meta http-equiv="refresh" content="2; url=student_home.php"/>';
            } else {
...
<head>
    ...
    <style>
        body {
            background-image: url('stu_login.JFIF');

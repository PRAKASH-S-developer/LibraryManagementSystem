...
if (isset($_GET["delete"])) {
    ...
    if (mysqli_query($conn, $delete_query)) {
        ...
        echo '<meta http-equiv="refresh" content="0; url=lib_add_students_home.php"/>';
    } else {
...
<head>
    ...
    <title>Delete or Update Students</title>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <form method="POST" action="">
                            <button class="btn btn-danger btn-sm"><a href="lib_add_students_home.php" style="color: white; text-decoration: none;">Back</a></button>
                        </form>
                    </li>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <li class="nav-item">
            ...
            <tbody id="studentTable">
                <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                    <tr>
                        ...
                        <td><?= $row['address']; ?></td>
                        <td>
                            <a href="lib_update_student.php?id=<?= $row['stu_id']; ?>" class="btn btn-warning btn-sm btn-action">Update</a>
                            <a href="lib_delete_update_students.php?delete=<?= $row['stu_id']; ?>" class="btn btn-danger btn-sm btn-action" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>

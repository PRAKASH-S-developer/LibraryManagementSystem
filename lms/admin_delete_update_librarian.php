...
if (isset($_GET['delete'])) {
    ...
    $delete_query = "DELETE FROM lib_acc_create WHERE lib_id = $lib_id";
    if (mysqli_query($conn, $delete_query)) {
        $feedback_message = "Librarian ID <strong>$lib_id</strong> has been deleted successfully!";
        $feedback_class = 'alert-success';
    } else {
        $feedback_message = "Failed to delete Staff ID <strong>$lib_id</strong>.";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="librarian_acc_create_home.php">Back</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container my-4">
        <h2 class="text-center mb-4">Manage Librarian</h2>
        ...
        <?php if (!empty($feedback_message)): ?>
            ...
            <?php if ($redirect): ?>
                <script>
                    setTimeout(function() {
                        window.location.href = 'librarian_acc_create_home.php';
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="" style="display:inline-block;">
                                <input type="hidden" name="staff_id" value="<?php echo $row['lib_id']; ?>">
                        ...
                        <td>
                            ...
                            <a href="?delete=<?php echo $row['lib_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Librarian?');">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>

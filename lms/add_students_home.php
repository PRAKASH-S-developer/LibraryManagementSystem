...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('add_student.jpeg');
        ...
        <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        ...
                        <p class="card-text">View All Students details.</p>
                        <a href="admin_view_all_students.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        ...
                        <p class="card-text">Adding new Student details to the system.</p>
                        <a href="student_acc_create.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">Delete or Update Students</h5>
                        <p class="card-text">Delete Or Update Students.</p>
                        <a href="admin_delete_update_students.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>

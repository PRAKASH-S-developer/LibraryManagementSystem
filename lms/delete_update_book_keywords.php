    ...
    <div class="container my-4">
        ...
        <?php if (!empty($feedback_message)): ?>
            ...
            <?php if ($redirect): ?>
                <script>
                    setTimeout(function() {
                        window.location.href = 'lib_add_book_keyword_home.php';
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete_update_book_keywords.php?delete=<?php echo $row['book_keyword_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this keyword?');">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>

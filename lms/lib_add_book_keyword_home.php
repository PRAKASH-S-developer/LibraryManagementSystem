...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('cupboard1.jpg');
    ...
    <div class="container my-4">
        ...
        <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">View All Book Keywords</h5>
                        <p class="card-text">View All Book Keywords details.</p>
                        <a href="view_all_book_keywords.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">Add New Book Keywords</h5>
                        <p class="card-text">Adding new Book Keywords to the system.</p>
                        <a href="lib_add_new_book_keywords.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">Delete or Update Keywords.</h5>
                        <p class="card-text">Delete Or Update Book Keywords.</p>
                        <a href="delete_update_book_keywords.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>

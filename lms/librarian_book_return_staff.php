...
// Fetch all books
$query = "SELECT * FROM temp_staffs_return_book_request";
...
<div class="container mt-5">
    <h2 class="text-center mb-4 text-warning">📚 All Return Books Request</h2>
    ...
    <a href="staffs_not_returned_books.php" class="btn btn-secondary">Staff Not<br>Returned Books</a>
        ...
        <tbody id="bookTable">
            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                    ...
                    <td>
                        <a href="return_book_staff.php?bid=<?php echo $row['bid']; ?>&staff_id=<?php echo $row['staff_id']; ?>" class="btn btn-sm btn-primary">Accept</a><br><br>
                    </td>

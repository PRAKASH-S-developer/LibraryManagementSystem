...
$result10 = mysqli_query($conn, "SELECT returned_date FROM returned_books WHERE rollno='$rollno' AND email='$email'");

$returned_date = "You have not returned this books yet.";
...
// Fetch all books issued to the student
$query = "SELECT * FROM returned_books WHERE rollno='$rollno' AND email='$email'";
...
<div class="container mt-5">
    <h2 class="text-center mb-4 text-warning">📚 Returned Books</h2>

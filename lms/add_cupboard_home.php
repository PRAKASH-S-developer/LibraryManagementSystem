        ...
        <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        ...
                        <a href="view_all_cupboards.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        ...
                        <a href="add_new_cupboard.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        ...
                        <a href="delete_update_cupboard.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>

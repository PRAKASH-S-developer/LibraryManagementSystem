...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                    <!-- <a class="nav-link" href="add_book_keyword_home.php">Back</a> -->
                    <form method="POST" action="">
                            <button  class="btn btn-danger btn-sm"><a href="lib_add_book_keyword_home.php">Back</a></button>
                        </form>
                    </li> &nbsp;&nbsp;&nbsp;&nbsp;
                    <li class="nav-item">
                        <form method="POST" action="">
    ...
    <div class="container my-4">
        <h1 class="text-center mb-4">Available Book Keyword</h1>

        <table class="table table-bordered table-hover">
            <thead class="table-dark">
                <tr>
                    <th scope="col">Book Keyword ID</th>
                    <th scope="col">Book Keyword Name</th>
                </tr>
            </thead>
            <tbody>
                <?php
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<td>" . $row['book_keyword_id'] . "</td>";
                        echo "<td>" . $row['book_keyword'] . "</td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='2' class='text-center'>No book keyword available</td></tr>";
                }
                ?>
            </tbody>
        </table>

                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete_shelves.php?delete=<?php echo $row['shelve_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this shelf?');">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>

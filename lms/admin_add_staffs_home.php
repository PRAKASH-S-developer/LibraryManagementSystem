...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('add_staff2.jpg');
    ...
    <div class="container my-4">
        ...
        <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">View All Staffs</h5>
                        <p class="card-text">View All Staffs details.</p>
                        <a href="admin_view_all_staffs.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">Add New Staffs</h5>
                        <p class="card-text">Adding new Staffs details to the system.</p>
                        <a href="staff_acc_create.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <h5 class="card-title">Delete or Update Staffs</h5>
                        <p class="card-text">Delete Or Update Staffs.</p>
                        <a href="admin_delete_update_staffs.php" class="btn btn-primary">Go</a>
                    </div>
                </div>
            </div>

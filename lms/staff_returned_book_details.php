...
$query = "SELECT * FROM returned_books_staffs WHERE 1=1";
if (!empty($search)) {
...
if (isset($_POST["generate_pdf"])) {
    ...
    // Title
    $pdf->SetXY(0, 10);
    $pdf->Cell(0, 10, 'Library Management System - Staff Returned Books Report', 0, 1, 'C');
    ...
    $header = array('S.NO', 'Acc No', 'Title', 'Author', 'Staff Name', 'Issued Date', 'Returned Date');
    ...
    $pdf_filename = 'Staff_Returned_Books_Report_' . date('Y-m-d');
    if (!empty($search)) {
...
<head>
    ...
    <title>Staff Returned Books</title>
...
<div class="container mt-5">
    <h2 class="text-center mb-4 text-warning">📚 Staff Returned Books</h2>
    ...
    <!-- Table to Display Staff Returned Books -->
    <table class="table table-bordered table-hover">
        ...
        <tbody id="bookTable">
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<tr><td colspan="12" class="no-results">No returned books found matching your criteria</td></tr>';
            }
            ?>
        </tbody>
    </table>
